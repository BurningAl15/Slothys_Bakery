...
{
    using Core;
    public class SignDraggable : MonoBehaviour
    {
        ...
        [Header("For interaction")] [SerializeField]
        private bool isSelected;

        [SerializeField] private bool isBeingDragged;

        [Header("Check if draggable is in initial zone or recognition zone")] [SerializeField]
        ...
        public void IsNotInRecognitionZone_WithoutCollider()
        {
            isInRecognitionZone = false;
        }
